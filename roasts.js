...
(function() {
    ...
    const roastComponents = {
        ...
        openers: {
            ...
            appearance: [
                "You look like", "Your appearance is", "Your face resembles", 
                "Your style is", "You dress like", "Your haircut looks like",
                "Your fashion sense is", "Your entire aesthetic is",
                "Visually, you're basically", "Your whole look screams"
            ],
            personality: [
                "Your personality is", "Your vibe is", "You give off", 
                "Your energy is", "Talking to you is like", "Being around you is like",
                "Your presence is", "Your attitude is", "Mentally, you're",
                "The way you act is"
            ],
            skills: [
                "Your abilities are", "Your talent is", "Your skill level is", 
                "Your competence is", "The way you perform is", "Your technique is",
                "Your approach to tasks is", "Your method is", "Your execution is",
                "Your capability is"
            ]
        },
        
        // Descriptors - the main insult component
        descriptors: {
            ...
            3: {
                ...
                appearance: [
                    "what would emerge if", "what would crawl out of", 
        ...
        // Objects - what they're being compared to
        objects: {
            // Intensity level 1 (Mild)
            1: {
                general: [
                ...
                appearance: [
                    "a child's first attempt at using crayons ", "a randomized video game character ", 
                ...
                personality: [
                    "watching paint dry", "the 'Terms and Conditions' page", 
                ...
                skills: [
                    ...
                    "someone typing with oven mitts on", "writing with the wrong hand", 
            ...
            3: {
                ...
                appearance: [
                    "a caricature artist's worst nightmare", "what happens when you let a blindfolded child use Photoshop", 
                ...
                personality: [
                    ...
                    "the concept of boredom gaining sentience", "what happens when beige becomes self-aware", 
    ...
    // Add more roast content for skills category that was incomplete in the original
    const roastCollection = {
        ...
        personality: {
            ...
            // Intensity level 3 (Savage)
            3: [
                "Your personality has less dimensions than a straight line ",
        ...
        skills: {
            ...
            1: [
                ...
                "Your skill set is like a Swiss cheese - mostly holes ",
